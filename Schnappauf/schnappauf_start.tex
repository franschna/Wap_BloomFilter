...
\subsection{Lösungsansatz - Bloomfilter}
...
Bloomfilter balancieren drei zentrale Faktoren. Neben der Reject-Time (Zeit zur Ablehnung von Nicht-Mitgliedern) und dem benötigten Speicherplatz, die auch in konventionellen Hashing-Methoden berücksichtigt werden müssen, wird hier auch die erlaubte Fehlerrate betrachtet. Der zentrale Trade-off ist dabei zwischen dem akzeptablen Anteil an False-Positives und der Speichereffizienz. Dieser ist bei der Implementierung eines Bloomfilters individuell konfigurierbar. 
...
Bloomfilter sind besonders hilfreich, wenn die Mehrheit der Anfragen nicht-existente Elemente betrifft – hier liefern sie schnell ein definitives „Nein“ auf die Membership-Frage. \cite{burtonbloom}
